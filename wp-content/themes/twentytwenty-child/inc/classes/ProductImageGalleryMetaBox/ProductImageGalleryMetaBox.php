...
class ProductImageGalleryMetaBox{
	...
	public function add_meta_boxes() {
		foreach ( $this->screen as $single_screen ) {
			add_meta_box(
				...
				__( 'ProductImageGallery', 'textdomain' ),
	...
	public function meta_box_callback( $post ) {
		wp_nonce_field( 'ProductImageGallery_data', 'ProductImageGallery_nonce' );
	...
	public function save_fields( $post_id ) {
		if ( ! isset( $_POST['ProductImageGallery_nonce'] ) )
			return $post_id;
		$nonce = $_POST['ProductImageGallery_nonce'];
		if ( !wp_verify_nonce( $nonce, 'ProductImageGallery_data' ) )
			return $post_id;
